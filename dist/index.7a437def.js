...
return"function"!=typeof e||e.hasOwnProperty("prototype")});var $=Function.prototype.call;j=O?$.bind($):function(){return $.apply($,arguments)};var L={}.propertyIsEnumerable,M=Object.getOwnPropertyDescriptor;o=M&&!L.call({1:2},1)?function(e){var t=M(this,e);return!!t&&t.enumerable}:L;var P={};P=function(e,t){return{enumerable:!(1&e),configurable:!(2&e),writable:!(4&e),value:t}};var x={},T={},A={},H=Function.prototype,I=H.call,q=O&&H.bind.bind(I,I),N={},C=(A=O?q:function(e){return function(){return I.apply(e,arguments)}})({}.toString),D=A("".slice);N=function(e){return D(C(e),8,-1)};var R=Object,W=A("".split);// fallback for non-array-like ES3 and non-enumerable old V8 strings
...
eO=function(e){return e$(z(e))};var eL=A({}.hasOwnProperty);// `HasOwnProperty` abstract operation
// https://tc39.es/ecma262/#sec-hasownproperty
// eslint-disable-next-line es/no-object-hasown -- safe
ej=Object.hasOwn||function(e,t){return eL(eO(e),t)};var eM={},eP=0,ex=Math.random(),eT=A(1..toString);eM=function(e){return"Symbol("+(void 0===e?"":e)+")_"+eT(++eP+ex,36)};var eA=k.Symbol,eH=e_("wks"),eI=en?eA.for||eA:eA&&eA.withoutSetter||eM,eq=TypeError,eN=(ej(eH,e="toPrimitive")||(eH[e]=ei&&ej(eA,e)?eA[e]:eI("Symbol."+e)),eH[e]);// `ToPrimitive` abstract operation
// https://tc39.es/ecma262/#sec-toprimitive
J=function(e,t){if(!Y(e)||ee(e))return e;var r,n=ef(e,eN);if(n){if(void 0===t&&(t="default"),r=j(n,e,t),!Y(r)||ee(r))return r;throw new eq("Can't convert object to primitive value")}return void 0===t&&(t="number"),ey(e,t)},// `ToPropertyKey` abstract operation
...
var ez=Object.getOwnPropertyDescriptor;i=S?ez:function(e,t){if(e=x(e),t=B(t),eC)try{return ez(e,t)}catch(e){}if(ej(e,t))return P(!j(o,e,t),e[t])};var eG={},eU={};// V8 ~ Chrome 36-
...
tV=function(e,t){return eh(e),void 0===t?e:O?tX(e,t):function(){return e.apply(t,arguments)}};var tZ={};tZ=et("document","documentElement");var t0={};t0=A([].slice);var t1={},t2=TypeError;t1=function(e,t){if(e<t)throw new t2("Not enough arguments");return e};var t4={};// eslint-disable-next-line redos/no-vulnerable -- safe
t4=/(?:ipad|iphone|ipod).*applewebkit/i.test(ea);var t5={};t5="process"===N(k.process);var t3=k.setImmediate,t9=k.clearImmediate,t7=k.process,t8=k.Dispatch,t6=k.Function,re=k.MessageChannel,rt=k.String,rr=0,rn={},ri="onreadystatechange";F(function(){// Deno throws a ReferenceError on `location` access without `--location` flag
...
k.postMessage(rt(e),h.protocol+"//"+h.host)};t3&&t9||(t3=function(e){t1(arguments.length,1);var t=Q(e)?e:t6(e),r=t0(arguments,1);return rn[++rr]=function(){tB(t,void 0,r)},g(rr),rr},t9=function(e){delete rn[e]},t5?g=function(e){t7.nextTick(ra(e))}:t8&&t8.now?g=function(e){t8.now(ra(e))}:re&&!t4?(m=(v=new re).port2,v.port1.onmessage=rs,g=tV(m.postMessage,m)):k.addEventListener&&Q(k.postMessage)&&!k.importScripts&&h&&"file:"!==h.protocol&&!F(rc)?(g=rc,k.addEventListener("message",rs,!1)):g=ri in eD("script")?function(e){tZ.appendChild(eD("script"))[ri]=function(){tZ.removeChild(this),ro(e)}}:function(e){setTimeout(ra(e),0)});var ru=(tU={set:t3,clear:t9}).clear;// `clearImmediate` method
...
"object"==typeof globalThis?globalThis.regeneratorRuntime=rv:Function("r","regeneratorRuntime = r")(rv)}const rm="https://forkify-api.herokuapp.com/api/v2/recipes/",ry="5fa49b6c-5047-4e2a-9dd2-4d5d8e14ca35",rb=async function(e,t){try{let r=t?fetch(e,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t)}):fetch(e),n=await Promise.race([r,new Promise(function(e,t){setTimeout(function(){t(Error("Request took too long! Timeout after 10 second"))},1e4)})]),i=await n.json();if(!n.ok)throw new error(`${i.message} (${n.status})`);return i}catch(e){throw e}},r_={recipe:{},search:{query:"",results:[],resultsPerPage:10,page:1},bookmarks:[]},rw=function(e){let{recipe:t}=e.data;return{id:t.id,title:t.title,publisher:t.publisher,sourceUrl:t.source_url,image:t.image_url,servings:t.servings,cookingTime:t.cooking_time,ingredients:t.ingredients,...t.key&&{key:t.key}}},rk=async function(e){try{let t=await rb(`${rm}${e}?key=${ry}`);r_.recipe=rw(t),r_.bookmarks.some(t=>t.id===e)?r_.recipe.bookmarked=!0:r_.recipe.bookmarked=!1,console.log(r_.recipe)}catch(e){throw console.error(`${e} \u{1F4A5}\u{1F4A5}\u{1F4A5}\u{1F4A5}\u{1F4A5}`),e}},rE=async function(e){try{let t=await rb(`${rm}?search=${e}&key=${ry}`);console.log(t),r_.search.results=t.data.recipes.map(e=>({id:e.id,title:e.title,publisher:e.publisher,image:e.image_url,...e.key&&{key:e.key}})),r_.search.page=1}catch(e){throw console.error(`${e} \u{1F4A5}\u{1F4A5}\u{1F4A5}\u{1F4A5}\u{1F4A5}`),e}},rS=function(e=r_.search.page){r_.search.page=e;let t=(e-1)*r_.search.resultsPerPage,r=e*r_.search.resultsPerPage;return r_.search.results.slice(t,r)},rF=function(e){r_.recipe.ingredients.forEach(t=>{t.quantity=t.quantity*e/r_.recipe.servings}),r_.recipe.servings=e},rj=function(){localStorage.setItem("bookmarks",JSON.stringify(r_.bookmarks))},rO=function(e){// add Bookmarks
r_.bookmarks.push(e),e.id===r_.recipe.id&&(r_.recipe.bookmarked=!0),rj()},r$=function(e){// delete bookmarks
let t=r_.bookmarks.findIndex(t=>t.id===e);r_.bookmarks.splice(t,1),e===r_.recipe.id&&(r_.recipe.bookmarked=!1),rj()};!function(){let e=localStorage.getItem("bookmarks");e&&(r_.bookmarks=JSON.parse(e))}();const rL=async function(e){try{let t=Object.entries(e).filter(e=>e[0].startsWith("ingredient")&&""!==e[1]).map(e=>{let t=e[1].split(",").map(e=>e.trim());if(3!==t.length)throw Error("Wrong ingredient format! Please use the correct format");let[r,n,i]=t;return{quantity:r?+r:null,unit:n,description:i}}),r={title:e.title,source_url:e.sourceUrl,image_url:e.image,publisher:e.publisher,cooking_time:+e.cookingTime,servings:+e.servings,ingredients:t},n=await rb(`${rm}?key=${ry}`,r);r_.recipe=rw(n),rO(r_.recipe)}catch(e){throw e}};// import icons from 'url:../img/icons.svg';
// import { forEach } from 'core-js/core/array';
var rM={};rM=new URL("icons.c14567a0.svg",import.meta.url).toString();class rP{_data;/**
...
return 1!=t&&r.push(t),r;// Return the prime factors
    ...
    </li>`}}var rT=new rx;class rA{_parentEl=document.querySelector(".search");getQuery(){let e=this._parentEl.querySelector(".search__field").value;return this._clearInput(),e}_clearInput(){this._parentEl.querySelector(".search__field").value=""}addHandlerSearch(e){this._parentEl.addEventListener("submit",function(t){t.preventDefault(),e()})}}var rH=new rA,rI=new // import View from './view.js';
...
class extends rP{_parentElement="";_generateMarkup(){let e=window.location.hash.slice(1);return`
      <li class="preview">
...
1===e&&t>1?`<button data-goto="${e+1}" class="btn--inline pagination__btn--next">
    ...
    </button>`:"")}}var rD=new rC;class rR extends rP{_parentElement=document.querySelector(".bookmarks__list");_errorMessage="No bookmarks yet,find a nice recipe and bookmark it";_message="";addHandlerRender(e){window.addEventListener("load",e)}_generateMarkup(){return this._data.map(e=>rI.render(e,!1)).join("")}}var rW=new rR;class rz extends rP{_parentElement=document.querySelector(".upload");_message="Recipe was successfully uploaded";_window=document.querySelector(".add-recipe-window");_overlay=document.querySelector(".overlay");_btnOpen=document.querySelector(".nav__btn--add-recipe");_btnClose=document.querySelector(".btn--close-modal");constructor(){super(),this._addHandlerShowWindow(),this._addHandlerHideWindow()}toggleWindow(){this._overlay.classList.toggle("hidden"),this._window.classList.toggle("hidden")}_addHandlerShowWindow(){this._btnOpen.addEventListener("click",this.toggleWindow.bind(this))}_addHandlerHideWindow(){this._btnClose.addEventListener("click",this.toggleWindow.bind(this)),this._overlay.addEventListener("click",this.toggleWindow.bind(this))}addHandlerUpload(e){this._parentElement.addEventListener("submit",function(t){t.preventDefault();let r=[...new FormData(this)],n=Object.fromEntries(r);e(n)})}_generateMarkup(){}}var rG=new rz;// if (module.hot) {
//   module.hot.accept();
// }
const rU=async function(){try{let e=window.location.hash.slice(1);if(!e)return;rT.renderSpinner(),rN.update(rS()),rW.update(r_.bookmarks),// loading recipe
await rk(e),rT.render(r_.recipe)}catch(e){rT.renderError()}},rB=async function(){try{rN.renderSpinner();// Get search query
let e=rH.getQuery();if(!e)return;// load search result
await rE(e),rN.render(rS()),rD.render(r_.search)}catch(e){console.log(e)}},rJ=async function(e){try{rG.renderSpinner(),await rL(e),console.log(r_.recipe),rT.render(r_.recipe),rG.renderMessage(),rW.render(r_.bookmarks),//change ID in the url
window.history.pushState(null,"","model.stste.recipe.id"),// close form window
setTimeout(function(){rG.toggleWindow()},2500)}catch(e){console.error("\uD83D\uDCA5",e),rG.renderError(e.message)}};rW.addHandlerRender(function(){rW.render(r_.bookmarks)}),rT.addHandlerRender(rU),rT.addHandlerUpdateServings(function(e){//update the recipe servings
rF(e),rT.update(r_.recipe)}),rT.addHandlerAddBookmark(function(){r_.recipe.bookmarked?r$(r_.recipe.id):rO(r_.recipe),rT.update(r_.recipe),rW.render(r_.bookmarks)}),rH.addHandlerSearch(rB),rD.addHandlerClick(function(e){console.log(e),rN.render(rS(e)),rD.render(r_.search)}),rG.addHandlerUpload(rJ);//# sourceMappingURL=index.7a437def.js.map

//# sourceMappingURL=index.7a437def.js.map
